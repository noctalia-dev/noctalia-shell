                ...
                RowLayout {
                  ...
                  Rectangle {
                    ...
                    Loader {
                      ...
                      onActiveChanged: {
                        Logger.d("Launcher", "iconLoader active changed | index:", index, "| iconName:", modelData?.icon, "| active:", active, "| visible:", visible)
                      }
                      onVisibleChanged: {
                        Logger.d("Launcher", "iconLoader visible changed | index:", index, "| iconName:", modelData?.icon, "| visible:", visible, "| active:", active)
                      }
                      ...
                      sourceComponent: Component {
                        Item {
                          ...
                          property string iconKey: modelData.icon || "application-x-executable"
                          ...
                          function updateIcon() {
                            ...
                            AppSearch.resolveIconWithFallback(iconKey, function(path) {
                              // Guard against delegate reuse
                              if (_requestKey === iconKey && path && path.length > 0) {
                                iconSrc = path
                              }
                            })
                          }
                          
                          onIconKeyChanged: updateIcon()
                          Component.onCompleted: updateIcon()
                          
                          // Use IconImage for icon names (theme-based icons)
                          IconImage {
                            id: listIcon
                            anchors.centerIn: parent
                            width: parent.width
                            ...
                            asynchronous: true
                            smooth: true
                            source: iconContainer.iconSrc && !iconContainer.iconSrc.startsWith("image://icon/") && !iconContainer.iconSrc.startsWith("file://") && !iconContainer.iconSrc.startsWith("/") ? iconContainer.iconSrc : ""
                            visible: source !== ""
                          }
                          
                          // Use regular Image for file:// URLs and image://icon/ URLs (IconImage doesn't support them)
                          Image {
                            id: listIconFallback
                            anchors.centerIn: parent
                            width: parent.width
              ...
              ColumnLayout {
                ...
                Rectangle {
                  ...
                  Loader {
                    ...
                    onActiveChanged: {
                      Logger.d("Launcher", "gridIconLoader active changed | index:", index, "| iconName:", modelData?.icon, "| active:", active, "| visible:", visible)
                    }
                    onVisibleChanged: {
                      Logger.d("Launcher", "gridIconLoader visible changed | index:", index, "| iconName:", modelData?.icon, "| visible:", visible, "| active:", active)
                    }
                    ...
                    sourceComponent: Component {
                      Item {
                        ...
                        IconImage {
                          ...
                          asynchronous: true
                          smooth: true
                          source: gridIconContainer.iconSrc && !gridIconContainer.iconSrc.startsWith("image://icon/") && !gridIconContainer.iconSrc.startsWith("file://") && !gridIconContainer.iconSrc.startsWith("/") ? gridIconContainer.iconSrc : ""
                          visible: source !== ""
                        }
