...
Singleton {
  ...
  readonly property var aliases: {
    ...
    "device-monitor": "device-tv",
    "device-desktop": "devices-pc",
    "device-ups": "battery-automotive",
    "device-pen": "pencil",
    "device-modem": "router",
    "device-audio": "speakerphone",
    "device-touchpad": "hand-finger",
    "device-media-player": "player-play",
    "device-remote": "device-remote",
    "device-printer": "printer",
    "device-scanner": "object-scan",
