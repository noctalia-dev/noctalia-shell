...
Scope {
  ...
  function tryUnlock() {
    Logger.i("LockContext", "tryUnlock called - pamAvailable:", pamAvailable,
             "waitingForPassword:", waitingForPassword, "currentText:", currentText !== "" ? "[has text]" : "[empty]",
             "unlockInProgress:", unlockInProgress, "abortInProgress:", abortInProgress);
