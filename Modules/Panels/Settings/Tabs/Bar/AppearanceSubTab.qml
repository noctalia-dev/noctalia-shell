...
ColumnLayout {
    ...
    NComboBox {
        ...
        description: I18n.tr("panels.bar.appearance-type-description") ?? "Choose the style of the bar: Simple, Floating, Island or Framed"
        model: [
            {
                "key": "simple",
        ...
        onSelected: key => {
            ...
            Settings.data.bar.island = (key === "island");
        }
    }
