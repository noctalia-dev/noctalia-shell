  ...
  contentItem: ColumnLayout {
    ...
    RowLayout {
      ...
      NTextInput {
        ...
        placeholderText: "Optional (Required for NSFW)"
        ...
        Connections {
          ...
          function onWallhavenApiKeyChanged() {
            if (apiKeyInput.text !== Settings.data.wallpaper.wallhavenApiKey) {
              apiKeyInput.text = Settings.data.wallpaper.wallhavenApiKey || "";
            }
          }
        }
