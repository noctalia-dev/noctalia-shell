...
namespace noctalia::config::schema {
  ...
  namespace {
    ...
    const Schema<ShellConfig::PanelConfig>& shellPanelSchema() {
      static const Schema<ShellConfig::PanelConfig> s = {
          ...
          enumField(&ShellConfig::PanelConfig::authPlacement, "auth_placement", kPanelPlacements),
          ...
          field(&ShellConfig::PanelConfig::authPosition, "auth_position"),
  ...
  const Schema<ShellConfig>& shellSchema() {
    static const Schema<ShellConfig> s = {
        ...
        field(&ShellConfig::systemdPasswordAgent, "systemd_password_agent"),
