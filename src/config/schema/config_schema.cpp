  ...
  namespace {
    ...
    const Schema<ShellConfig::PanelConfig>& shellPanelSchema() {
      static const Schema<ShellConfig::PanelConfig> s = {
          ...
          stringIfNonEmptyField(&ShellConfig::PanelConfig::launcherAnchorBar, "launcher_anchor_bar"),
          stringIfNonEmptyField(&ShellConfig::PanelConfig::clipboardAnchorBar, "clipboard_anchor_bar"),
          stringIfNonEmptyField(&ShellConfig::PanelConfig::controlCenterAnchorBar, "control_center_anchor_bar"),
          stringIfNonEmptyField(&ShellConfig::PanelConfig::wallpaperAnchorBar, "wallpaper_anchor_bar"),
          stringIfNonEmptyField(&ShellConfig::PanelConfig::sessionAnchorBar, "session_anchor_bar"),
          stringIfNonEmptyField(&ShellConfig::PanelConfig::polkitAnchorBar, "polkit_anchor_bar"),
