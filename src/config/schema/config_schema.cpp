...
namespace noctalia::config::schema {
  ...
  namespace {
    ...
    const Schema<LivePaperConfig>& livePaperSchema() {
      static const Schema<LivePaperConfig> s = {
          field(&LivePaperConfig::enabled, "enabled"),
          field(&LivePaperConfig::intervalSeconds, "interval_seconds", kLivePaperIntervalRange),
          ...
          field(&LivePaperConfig::allowMicFallback, "allow_mic_fallback"),
      };
      return s;
    }
  ...
  const Schema<WallpaperConfig>& wallpaperSchema() {
    static const Schema<WallpaperConfig> s = {
        ...
        subTable(&WallpaperConfig::livePaper, "live_paper", livePaperSchema()),
