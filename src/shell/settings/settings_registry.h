...
namespace settings {
  ...
  struct RegistryEnvironment {
    ...
    bool livePaperCompiledIn = false;               // build linked libprojectM (meson `livepaper` feature)
    bool livePaperAvailable = false;                // visualizer actually came up; false disables the toggle
