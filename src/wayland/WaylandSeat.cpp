#include "wayland/WaylandSeat.hpp"
...
void WaylandSeat::handlePointerEnter(void* data, wl_pointer* /*pointer*/, std::uint32_t serial,
...
void WaylandSeat::handlePointerLeave(void* data, wl_pointer* /*pointer*/, std::uint32_t serial,
                                      wl_surface* surface) {
    auto* self = static_cast<WaylandSeat*>(data);
    self->m_pendingPointerEvents.push_back(PointerEvent{
...
void WaylandSeat::handlePointerMotion(void* data, wl_pointer* /*pointer*/, std::uint32_t time,
...
void WaylandSeat::handlePointerButton(void* data, wl_pointer* /*pointer*/, std::uint32_t serial,
